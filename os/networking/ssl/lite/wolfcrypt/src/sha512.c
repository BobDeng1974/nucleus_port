...
#define WOLFSSL_R2(i) h(i)+=S1(e(i))+Ch(e(i),f(i),g(i))+K[i+j]+(j?blk2(i):blk384(i));\
	d(i)+=h(i);h(i)+=S0(a(i))+Maj(a(i),b(i),c(i))
...
static int Transform384(Sha384* sha384)
{
    ...
    /* 80 operations, partially loop unrolled */
    for (j = 0; j < 80; j += 16) {
        WOLFSSL_R2( 0); WOLFSSL_R2( 1); WOLFSSL_R2( 2); WOLFSSL_R2( 3);
        WOLFSSL_R2( 4); WOLFSSL_R2( 5); WOLFSSL_R2( 6); WOLFSSL_R2( 7);
        WOLFSSL_R2( 8); WOLFSSL_R2( 9); WOLFSSL_R2(10); WOLFSSL_R2(11);
        WOLFSSL_R2(12); WOLFSSL_R2(13); WOLFSSL_R2(14); WOLFSSL_R2(15);
    }
#endif /* USE_SLOW_SHA2 */
